...
export default function MemberEditTask({ currentTask, selectZIndex }) {
  ...
  const [values, setValues] = useState({
    ...
    priority: typeof currentTask.priority !== undefined ? options[3 - currentTask.priority] : options[0],
  ...
  return (
    <form
      className='edit-popup member-edit-task'
    ...
    >
      ...
      <div  className='edit-heading'>
        <p>Edit Project task</p>

        <CloseIcon
          className='close-edit'
          onClick={() => dispatch(removePopup('member edit project task'))}
        />
      </div>
      ...
      <div  className='edit-content'>
        ...
        <div className='fourth-line-wrapper'>
            ...
            <div className='date-time-container'>
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <MobileDateTimePicker
                  ...
                  value={dayjs(currentTask.startAt)}
          ...
          <div className='input-block'>
            ...
            <div className='date-time-container' style={{ cursor: 'auto !important'}}>
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <MobileDateTimePicker
                  readOnly
                  className='end-date'
                  format='MM/D/YYYY [at] h:mm a'
                  value={dayjs(currentTask.endAt)}
                  disableHighlightToday={true}
                  showDaysOutsideCurrentMonth={true}
                  slotProps={{ field: { shouldRespectLeadingZeros: true } }}
                />
